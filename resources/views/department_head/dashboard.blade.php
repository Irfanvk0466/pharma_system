...
<div class="row mb-2">
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item active">Department Head Dashboard</li>
        </ol>
    </div>
</div>
@endsection
...
<div class="row">
    @foreach($employees as $employee)
        <div class="col-md-4 col-lg-3 mb-4">
            <a href="{{ route('department_head.details', ['id' => $employee['id']]) }}" class="card-link" style="text-decoration: none;">
